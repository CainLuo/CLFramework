...
/**
 Separation分割线的宽度
 注意: 前提是你设置了toolBarStyle为CLToolBarSeparationStyle才有效, 默认为1
 */
@property (nonatomic, assign) CGFloat separationWidth;
...
/**
 指定当前选中的Button Index, 注意: 使用该方法, 必须先得实现reloadData的方法, 否则不生效
